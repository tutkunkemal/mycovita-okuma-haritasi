...
CATEGORIES = [
    {"id": "tur", "title": "Tür Ansiklopedileri", "emoji": "🍄", "tag": "Tür Ansiklopedileri"},
    {"id": "molekul", "title": "Molekül Ansiklopedisi", "emoji": "🔬", "tag": "Molekül Ansiklopedisi"},
    {"id": "gastro-bilim", "title": "Gastronomy Bilimi", "emoji": "🧪", "tag": "Gastronomy Bilimi"},
    {"id": "gastro", "title": "Gastronomy & Tarifler", "emoji": "🍳", "tag": "Gastronomy"},
    {"id": "apothecary", "title": "Apothecary", "emoji": "⚗️", "tag": "Apothecary"},
    {"id": "kullanim", "title": "Kullanım Rehberleri", "emoji": "📋", "tag": "Kullanım Rehberleri"},
    {"id": "satin", "title": "Satın Alma Kılavuzu", "emoji": "🛒", "tag": "Satın Alma Kılavuzu"},
    {"id": "kutuphane", "title": "Kütüphane", "emoji": "📚", "tag": "Kütüphane"},
]
...
def fetch_all_posts():
    ...
    page = 1
    while True:
        url = f"https://mycovita.bio/ghost/api/content/posts/?key={CONTENT_KEY}&limit=50&page={page}&include=tags&fields=title,slug"
...
<div class="oh-header">
  <p class="oh-title">🗺️ Okuma Haritası</p>
  <div class="oh-stats">
    <div class="oh-stat"><b>{total}</b><span>İçerik</span></div>
...
def update_ghost_page(html_content):
    ...
    update_url = f"{API_BASE}/pages/{page_id}/"
